...
import 'sup_model.dart';
export 'sup_model.dart';

class SupWidget extends StatefulWidget {
  const SupWidget({Key? key}) : super(key: key);

  @override
  _SupWidgetState createState() => _SupWidgetState();
}

class _SupWidgetState extends State<SupWidget> with TickerProviderStateMixin {
  late SupModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SupModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      context.pushNamedAuth('courseslist', context.mounted);
    });
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              image: DecorationImage(
                ...
                image: Image.asset(
                  'assets/images/Screen_Shot_1445-03-30_at_9.01.16_AM.png',
                ).image,
              ),
            ),
            child: Padding(
                ...
                children: [
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Image.asset(
                          'assets/images/Screen_Shot_1445-03-30_at_9.01.52_AM.png',
                          width: 347.0,
                          height: 105.0,
                          fit: BoxFit.contain,
                        ),
