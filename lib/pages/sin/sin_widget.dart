...
import 'sin_model.dart';
export 'sin_model.dart';

class SinWidget extends StatefulWidget {
  const SinWidget({Key? key}) : super(key: key);

  @override
  _SinWidgetState createState() => _SinWidgetState();
}

class _SinWidgetState extends State<SinWidget> with TickerProviderStateMixin {
  late SinModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SinModel());
